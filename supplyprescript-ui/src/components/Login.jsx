    ...
    <div style={styles.page}>
      <div style={styles.card} className="login-card">
        <div style={styles.brand}>
          <div style={styles.logoCircle} className="login-logo">SP</div>
          <h1 style={styles.title} className="login-title-gradient">SupplyPrescript</h1>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
         ...
         Keep me signed in
          ...
          <button type="submit" disabled={loading} style={styles.submitBtn} className="login-submit-btn">
...
const styles = {
  page: {
    ...
    // NOTE: no background here anymore — AnimatedBackground renders behind this
    // component (see App.jsx), so this page stays transparent to let it show through.
  },
  card: {
